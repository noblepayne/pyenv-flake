...
which: no python in (/run/wrappers/bin:/home/wes/.nix-profile/bin:...)
# Or put in `.bash_profile`
[wes@nixos:~]$ eval "$(nix run github:noblepayne/pyenv-flake -- init -)"
[wes@nixos:~]$ which python
...
# can start with an empty hash to have nix fail and tell you the hash, see below
